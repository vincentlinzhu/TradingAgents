...
class AzureOpenAIClient(BaseLLMClient):
    ...
    def get_llm(self) -> Any:
        ...
        llm_kwargs = {
            ...
            # Defaults tuned for managed-deployment 429 backoffs (gateway PTU
            # throttle can take a minute+ to free up) and slow modelhub
            # responses. Explicit caller kwargs below still win.
            "max_retries": 8,
            "timeout": 600,
        }
